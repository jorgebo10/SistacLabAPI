        ...
        Foto
            ...
            .then(
                function(foto) {
                    if (null === foto) {
                        return responseUtils.sendJsonResponse(res, 404, {
                            'message': 'No results found while searching by id ' + req.params.id
                        });
                    } else {
                        logger.info('Found foto with id %s while searching by id %s', foto._id, req.params.id);
                        return responseUtils.sendJsonResponse(res, 200, {
                            id: foto._id,
        ...
        Foto
            ...
            .then(
                function(fotos) {
                    ...
                    return responseUtils.sendJsonResponse(res, 200, fotoList);
                }
            )
            .catch(
                function(err) {
        ...
        Foto
            ...
            .then(
                function(foto) {
                    ...
                    return responseUtils.sendJsonResponse(res, 204, null);
                }
            )
            .catch(
                function(err) {
            ...
            .then(
                function(fotoWithDuplicateTag) {
                    if (fotoWithDuplicateTag && fotoWithDuplicateTag._id !== req.params.id) {
                        return responseUtils.sendJsonResponse(res, 400, {
                        ...
                        .then(
                            function(foto) {
                                if (null === foto) {
                                    ...
                                    return responseUtils.sendJsonResponse(res, 200, foto._id);
                                }
                            }
                        );
                }
